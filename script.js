...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".parallax-bg, .about-bg").forEach(parallax => {
...
if (closePopup && contactPopup) {
  ...
  // Закрытие service-overlay при клике по фону
document.querySelectorAll('.service-overlay').forEach(ov => {
